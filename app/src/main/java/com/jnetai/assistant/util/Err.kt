...
object Err {
    ...
    const val INTERNET_SEARCH_ERROR = "E0106"
    ...
    private val codes = setOf(
        ...
        NETWORK_HTTP, NETWORK_SSL, INTERNET_SEARCH_ERROR,
        API_UNAUTHORIZED, API_RATE_LIMIT, API_SERVER_ERROR,
        ...
        AGENT_PERMISSION, SHELL_ERROR, CLIPBOARD_ERROR,
        LOCAL_MODEL_LOAD, LOCAL_MODEL_MEM, BACKUP_ERROR, SKILLS_ERROR, USAGE_LIMIT,
        FATAL
    )
